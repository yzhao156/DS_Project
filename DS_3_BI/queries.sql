--1.a.1: Drill down:
SELECT count(*) as cases, D.year as year, D.quarter as quarter, D.month as month, D.day_of_month as day
...
ORDER BY D.year, D.quarter, D.month, day
...
WHERE F.PHU_location_key = P.surrogate_key AND
	...
	P.Reporting_PHU = 'Ottawa Public Health'
GROUP BY (P.reporting_phu_city, D.date)
ORDER BY D.date
